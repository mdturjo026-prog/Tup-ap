...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [[InlineKeyboardButton("💵 Open Shop", web_app=WebAppInfo(url="https://তোমার-ইউজারনেম.github.io/topup-app/"))]]
